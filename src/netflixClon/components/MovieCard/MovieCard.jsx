...
export const MovieCard = ({id, info}) => {

  return (
    <>
    
    <Link to={`/movie/${info?.title || info?.name}`} className='w-[160px] sm:w-[200px] md:w-[240px] lg:w-[280px] inline-block cursor-pointer relative p-2'>
